maximumsignaturelines
=====================

Allows adminitrators to set a maximum line count for signatures, in addition to the existing character length, to prevent signatures with many lines.
